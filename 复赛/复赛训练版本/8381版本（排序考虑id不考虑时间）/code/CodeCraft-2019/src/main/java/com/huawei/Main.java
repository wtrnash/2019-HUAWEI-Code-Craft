    ...
    public static void main(String[] args) throws IOException {
        ...
        carArr.sort(new Comparator<String[]>() {
            ...
            public int compare(String[] o1, String[] o2) {
                int id1 = Integer.valueOf(o1[0]), id2=Integer.valueOf(o2[0]);
        ...
        for(int i=0;i<carArr.size();i++){
            ...
            {
                count++;
                if(count / 4 < maxStartTime)    //预置车辆发的时候也跟着发车
                {
                    ...
                    startTime =Math.max(Integer.valueOf(carArr.get(i)[4]), maxStartTime + (count -  4 * maxStartTime)/ 33);
                }
            ...
            else if(i == priorityNumber)
            {
                ...
                commonStartTime = startTime + 300;
                count = 0;
            }
            else
            {
                count++;
                startTime =Math.max(Integer.valueOf(carArr.get(i)[4]), commonStartTime + count / 33); //普通车
            }
