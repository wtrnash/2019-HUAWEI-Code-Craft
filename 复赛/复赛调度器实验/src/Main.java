...
public class Main {
    public static void main(String[] args) throws IOException {
        BufferedReader carBf=new BufferedReader(new FileReader("train1/car.txt"));
        BufferedReader crossBf=new BufferedReader(new FileReader("train1/cross.txt"));
        BufferedReader roadBf=new BufferedReader(new FileReader("train1/road.txt"));
        //BufferedReader presetAnswerBf=new BufferedReader(new FileReader("train1/answerTxt.txt"));
        BufferedReader presetAnswerBf=new BufferedReader(new FileReader("train1/presetAnswer.txt"));
        BufferedReader allAnswerBf=new BufferedReader(new FileReader("train1/answer.txt"));
